 ...
 * @method \App\Model\Entity\AssessmentType findOrCreate($search, callable $callback = null, $options = [])
 *
...
class AssessmentTypesTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('assessment_types');
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
         ...
         $validator
            ->integer('standard_display_setting')
            ->notEmpty('standard_display_setting');
