 ...
 * Terms Model
 *
 * @property \App\Model\Table\AcademicYearsTable|\Cake\ORM\Association\BelongsTo $AcademicYears
 * @property \App\Model\Table\DivisionsTable|\Cake\ORM\Association\BelongsTo $Divisions
 * @property |\Cake\ORM\Association\HasMany $ReportingPeriods
...
class TermsTable extends Table
{
    ...
    {
        $rules->add($rules->existsIn(['academic_year_id'], 'AcademicYears'));
