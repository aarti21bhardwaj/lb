...
class AssessmentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'assessment_type_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        'is_accessible' => ['type' => 'boolean', 'length' => null, 'null' => true, 'default' => '0', 'comment' => '', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'is_accessible' => 1,
            'is_published' => 1,
            'created' => '2018-01-11 12:46:45',
            'modified' => '2018-01-11 12:46:45'
        ],
    ];
}
