...
class CoursesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'learning_area_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'grade_id' => 1,
            'created' => '2018-02-16 07:23:38',
            'modified' => '2018-02-16 07:23:38',
            'learning_area_id' => 1
        ],
    ];
}
