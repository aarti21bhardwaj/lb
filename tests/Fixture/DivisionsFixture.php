...
class DivisionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'campus_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'school_id' => 1,
            'created' => '2018-01-25 11:13:46',
            'modified' => '2018-01-25 11:13:46',
            'campus_id' => 1,
            'template_id' => 1
        ],
    ];
