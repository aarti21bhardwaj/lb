 ...
 *
 */
class ImpactsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'impact_category_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2018-01-02 11:21:17',
            'modified' => '2018-01-02 11:21:17',
            'parent_id' => 1,
            'lft' => 1,
            'rght' => 1
        ],
