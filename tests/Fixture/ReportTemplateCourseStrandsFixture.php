...
/**
 * ReportTemplateCourseStrandsFixture
 *
 */
class ReportTemplateCourseStrandsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'strand_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'grade_id' => 1,
            'strand_id' => 1,
            'created' => '2018-02-21 12:36:54',
            'modified' => '2018-02-21 12:36:54'
        ],
    ];
}
