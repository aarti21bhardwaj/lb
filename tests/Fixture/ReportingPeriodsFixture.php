...
/**
 * ReportingPeriodsFixture
 *
 */
class ReportingPeriodsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'closing_date' => ['type' => 'date', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'end_date' => '2018-02-16',
            'closing_date' => '2018-02-16',
            'term_id' => 1,
            'created' => '2018-02-16 11:11:29',
            'modified' => '2018-02-16 11:11:29'
        ],
    ];
}
