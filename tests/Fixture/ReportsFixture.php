...
class ReportsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'report_page_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'course_id' => 1,
            'sort_order' => 1,
            'created' => '2018-02-16 11:11:19',
            'modified' => '2018-02-16 11:11:19'
        ],
    ];
}
