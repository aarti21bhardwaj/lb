...
/**
 * SectionEventsFixture
 *
 */
class SectionEventsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'object_name' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
