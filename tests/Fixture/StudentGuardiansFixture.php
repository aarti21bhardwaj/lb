...
/**
 * StudentGuardiansFixture
 *
 */
class StudentGuardiansFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'relationship_type' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        '_constraints' => [
