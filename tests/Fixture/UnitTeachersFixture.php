 ...
 *
 */
class UnitTeachersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'is_creator' => ['type' => 'boolean', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'teacher_id' => 1,
            'is_creator' => 1,
            'created' => '2018-01-02 10:49:05',
            'modified' => '2018-01-02 10:49:05'
        ],
    ];
}
