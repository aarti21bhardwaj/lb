...
class UnitsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'unit_type_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'trans_disciplinary_theme_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2018-01-18 07:32:01',
            'modified' => '2018-01-18 07:32:01',
            'created_by' => 1,
            'modified_by' => 1
        ],
    ];
