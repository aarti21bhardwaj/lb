...
use App\Model\Table\AssessmentContentsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\AssessmentContentsTable Test Case
 */
class AssessmentContentsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\AssessmentContentsTable
     */
    public $AssessmentContents;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('AssessmentContents') ? [] : ['className' => AssessmentContentsTable::class];
        $this->AssessmentContents = TableRegistry::get('AssessmentContents', $config);
    }
