...
use App\Model\Table\AssessmentImpactsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\AssessmentImpactsTable Test Case
 */
class AssessmentImpactsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\AssessmentImpactsTable
     */
    public $AssessmentImpacts;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('AssessmentImpacts') ? [] : ['className' => AssessmentImpactsTable::class];
        $this->AssessmentImpacts = TableRegistry::get('AssessmentImpacts', $config);
    }
