...
use App\Model\Table\AssessmentStrandsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\AssessmentStrandsTable Test Case
 */
class AssessmentStrandsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\AssessmentStrandsTable
     */
    public $AssessmentStrands;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('AssessmentStrands') ? [] : ['className' => AssessmentStrandsTable::class];
        $this->AssessmentStrands = TableRegistry::get('AssessmentStrands', $config);
    }
