...
use App\Model\Table\DivisionGradesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\DivisionGradesTable Test Case
 */
class DivisionGradesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\DivisionGradesTable
     */
    public $DivisionGrades;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('DivisionGrades') ? [] : ['className' => DivisionGradesTable::class];
        $this->DivisionGrades = TableRegistry::get('DivisionGrades', $config);
    }
