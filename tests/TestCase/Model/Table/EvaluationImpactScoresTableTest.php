...
use App\Model\Table\EvaluationImpactScoresTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\EvaluationImpactScoresTable Test Case
 */
class EvaluationImpactScoresTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\EvaluationImpactScoresTable
     */
    public $EvaluationImpactScores;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('EvaluationImpactScores') ? [] : ['className' => EvaluationImpactScoresTable::class];
        $this->EvaluationImpactScores = TableRegistry::get('EvaluationImpactScores', $config);
    }
    ...
    {
        unset($this->EvaluationImpactScores);
