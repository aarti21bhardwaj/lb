...
use App\Model\Table\EvidenceImpactScoresTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\EvidenceImpactScoresTable Test Case
 */
class EvidenceImpactScoresTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\EvidenceImpactScoresTable
     */
    public $EvidenceImpactScores;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('EvidenceImpactScores') ? [] : ['className' => EvidenceImpactScoresTable::class];
        $this->EvidenceImpactScores = TableRegistry::get('EvidenceImpactScores', $config);
    }
    ...
    {
        unset($this->EvidenceImpactScores);
