...
use App\Model\Table\EvidenceSectionsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\EvidenceSectionsTable Test Case
 */
class EvidenceSectionsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\EvidenceSectionsTable
     */
    public $EvidenceSections;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('EvidenceSections') ? [] : ['className' => EvidenceSectionsTable::class];
        $this->EvidenceSections = TableRegistry::get('EvidenceSections', $config);
    }
