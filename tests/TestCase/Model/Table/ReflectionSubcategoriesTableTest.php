...
use App\Model\Table\ReflectionSubcategoriesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\ReflectionSubcategoriesTable Test Case
 */
class ReflectionSubcategoriesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\ReflectionSubcategoriesTable
     */
    public $ReflectionSubcategories;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('ReflectionSubcategories') ? [] : ['className' => ReflectionSubcategoriesTable::class];
        $this->ReflectionSubcategories = TableRegistry::get('ReflectionSubcategories', $config);
    }
    ...
    {
        unset($this->ReflectionSubcategories);
