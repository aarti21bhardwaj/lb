...
use App\Model\Table\ReportTemplateCourseScoresTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\ReportTemplateCourseScoresTable Test Case
 */
class ReportTemplateCourseScoresTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\ReportTemplateCourseScoresTable
     */
    public $ReportTemplateCourseScores;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('ReportTemplateCourseScores') ? [] : ['className' => ReportTemplateCourseScoresTable::class];
        $this->ReportTemplateCourseScores = TableRegistry::get('ReportTemplateCourseScores', $config);
    }
    ...
    {
        unset($this->ReportTemplateCourseScores);
