...
use App\Model\Table\ReportTemplateCourseStrandsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\ReportTemplateCourseStrandsTable Test Case
 */
class ReportTemplateCourseStrandsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\ReportTemplateCourseStrandsTable
     */
    public $ReportTemplateCourseStrands;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('ReportTemplateCourseStrands') ? [] : ['className' => ReportTemplateCourseStrandsTable::class];
        $this->ReportTemplateCourseStrands = TableRegistry::get('ReportTemplateCourseStrands', $config);
    }
    ...
    {
        unset($this->ReportTemplateCourseStrands);
