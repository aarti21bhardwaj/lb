...
use App\Model\Table\ReportTemplateEmailSettingsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\ReportTemplateEmailSettingsTable Test Case
 */
class ReportTemplateEmailSettingsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\ReportTemplateEmailSettingsTable
     */
    public $ReportTemplateEmailSettings;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('ReportTemplateEmailSettings') ? [] : ['className' => ReportTemplateEmailSettingsTable::class];
        $this->ReportTemplateEmailSettings = TableRegistry::get('ReportTemplateEmailSettings', $config);
    }
    ...
    {
        unset($this->ReportTemplateEmailSettings);
