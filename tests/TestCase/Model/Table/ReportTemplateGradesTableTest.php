...
use App\Model\Table\ReportTemplateGradesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\ReportTemplateGradesTable Test Case
 */
class ReportTemplateGradesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\ReportTemplateGradesTable
     */
    public $ReportTemplateGrades;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('ReportTemplateGrades') ? [] : ['className' => ReportTemplateGradesTable::class];
        $this->ReportTemplateGrades = TableRegistry::get('ReportTemplateGrades', $config);
    }
    ...
    {
        unset($this->ReportTemplateGrades);
