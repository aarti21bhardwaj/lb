...
use App\Model\Table\ReportTemplateImpactScoresTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\ReportTemplateImpactScoresTable Test Case
 */
class ReportTemplateImpactScoresTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\ReportTemplateImpactScoresTable
     */
    public $ReportTemplateImpactScores;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('ReportTemplateImpactScores') ? [] : ['className' => ReportTemplateImpactScoresTable::class];
        $this->ReportTemplateImpactScores = TableRegistry::get('ReportTemplateImpactScores', $config);
    }
    ...
    {
        unset($this->ReportTemplateImpactScores);
