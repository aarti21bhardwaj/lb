...
use App\Model\Table\ReportTemplateImpactsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\ReportTemplateImpactsTable Test Case
 */
class ReportTemplateImpactsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\ReportTemplateImpactsTable
     */
    public $ReportTemplateImpacts;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('ReportTemplateImpacts') ? [] : ['className' => ReportTemplateImpactsTable::class];
        $this->ReportTemplateImpacts = TableRegistry::get('ReportTemplateImpacts', $config);
    }
    ...
    {
        unset($this->ReportTemplateImpacts);
