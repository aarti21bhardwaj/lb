...
use App\Model\Table\ReportTemplateStandardsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\ReportTemplateStandardsTable Test Case
 */
class ReportTemplateStandardsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\ReportTemplateStandardsTable
     */
    public $ReportTemplateStandards;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('ReportTemplateStandards') ? [] : ['className' => ReportTemplateStandardsTable::class];
        $this->ReportTemplateStandards = TableRegistry::get('ReportTemplateStandards', $config);
    }
    ...
    {
        unset($this->ReportTemplateStandards);
