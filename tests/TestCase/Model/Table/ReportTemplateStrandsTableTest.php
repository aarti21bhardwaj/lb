...
use App\Model\Table\ReportTemplateStrandsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\ReportTemplateStrandsTable Test Case
 */
class ReportTemplateStrandsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\ReportTemplateStrandsTable
     */
    public $ReportTemplateStrands;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('ReportTemplateStrands') ? [] : ['className' => ReportTemplateStrandsTable::class];
        $this->ReportTemplateStrands = TableRegistry::get('ReportTemplateStrands', $config);
    }
    ...
    {
        unset($this->ReportTemplateStrands);
