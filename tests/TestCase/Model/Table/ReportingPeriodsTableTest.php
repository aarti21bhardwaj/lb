...
use App\Model\Table\ReportingPeriodsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\ReportingPeriodsTable Test Case
 */
class ReportingPeriodsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\ReportingPeriodsTable
     */
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('ReportingPeriods') ? [] : ['className' => ReportingPeriodsTable::class];
        $this->ReportingPeriods = TableRegistry::get('ReportingPeriods', $config);
    }
