...
use App\Model\Table\TeacherEvidenceImpactScoresTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\TeacherEvidenceImpactScoresTable Test Case
 */
class TeacherEvidenceImpactScoresTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\TeacherEvidenceImpactScoresTable
     */
    public $TeacherEvidenceImpactScores;
     ...
     */
    public $fixtures = [
        'app.teacher_evidence_impact_scores',
        'app.teacher_evidence_impacts',
        ...
        'app.campus_settings',
        'app.setting_keys',
        'app.teacher_evidence_contexts',
        'app.teacher_evidence_sections'
    ];
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('TeacherEvidenceImpactScores') ? [] : ['className' => TeacherEvidenceImpactScoresTable::class];
        $this->TeacherEvidenceImpactScores = TableRegistry::get('TeacherEvidenceImpactScores', $config);
    }
    ...
    {
        unset($this->TeacherEvidenceImpactScores);
