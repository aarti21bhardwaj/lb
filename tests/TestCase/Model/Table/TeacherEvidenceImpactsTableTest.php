...
use App\Model\Table\TeacherEvidenceImpactsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\TeacherEvidenceImpactsTable Test Case
 */
class TeacherEvidenceImpactsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\TeacherEvidenceImpactsTable
     */
    public $TeacherEvidenceImpacts;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('TeacherEvidenceImpacts') ? [] : ['className' => TeacherEvidenceImpactsTable::class];
        $this->TeacherEvidenceImpacts = TableRegistry::get('TeacherEvidenceImpacts', $config);
    }
    ...
    {
        unset($this->TeacherEvidenceImpacts);
